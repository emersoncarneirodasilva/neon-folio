...
> = ({ hour }) => {
  const signalingPoints = [
    { top: "16%", left: "14.5%", delay: "0s", type: "fixed" },
    { top: "16.5%", left: "17.6%", delay: "0.7s", type: "pulse" },
    { top: "6.5%", left: "64.1%", delay: "0s", type: "pulse" },
    { top: "2.1%", left: "86.6%", delay: "0s", type: "flicker" },
  ];
