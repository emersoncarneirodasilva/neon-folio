...
export default function Rain({ intensity }: RainProps) {
  const configurations = {
    low: {
      ...
      backgroundImage: `
        linear-gradient(98deg, transparent 0%, transparent 93%, rgba(255, 255, 255, 0.25) 95%, transparent 97%),
        linear-gradient(96deg, transparent 0%, transparent 88%, rgba(255, 255, 255, 0.15) 90%, transparent 92%)
      `,
      speed: "0.55s",
    },
    medium: {
      ...
      backgroundImage: `
        linear-gradient(99deg, transparent 0%, transparent 90%, rgba(255, 255, 255, 0.45) 92%, transparent 94%),
        linear-gradient(97deg, transparent 0%, transparent 86%, rgba(255, 255, 255, 0.3) 89%, transparent 92%),
        linear-gradient(101deg, transparent 0%, transparent 92%, rgba(255, 255, 255, 0.2) 94%, transparent 96%)
      `,
      speed: "0.35s",
    },
    storm: {
      ...
      backgroundImage: `
        linear-gradient(100deg, transparent 0%, transparent 85%, rgba(255, 255, 255, 0.6) 88%, transparent 91%),
        linear-gradient(98deg, transparent 0%, transparent 82%, rgba(255, 255, 255, 0.45) 86%, transparent 90%),
        linear-gradient(102deg, transparent 0%, transparent 88%, rgba(255, 255, 255, 0.35) 91%, transparent 94%)
      `,
      speed: "0.18s",
    },
  };
